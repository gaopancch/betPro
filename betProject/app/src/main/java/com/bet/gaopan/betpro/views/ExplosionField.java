...
import com.bet.gaopan.betpro.utils.DensityUtils;
...
public class ExplosionField extends View{
    ...
    public void explode(final View view) {
        ...
        rect.offset(0, -DensityUtils.dp2px(context,15)); //去掉状态栏高度
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (doAfterExplosiedListener!=null){
                    doAfterExplosiedListener.doAfterExploside(view);
                }
...
//                view.setOnClickListener(null); // 用过一次就不需要了
    ...
    private DoAfterExplosiedListener doAfterExplosiedListener;

    public void setDoAfterExplosiedListener(DoAfterExplosiedListener l){
        doAfterExplosiedListener=l;
    }

    public interface  DoAfterExplosiedListener{
